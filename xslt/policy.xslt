            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <p style="font-size:18px; ">
                  Kami, <b> PT L’Oréal Indonesia:</b>
                </p>
                <br/>
                <div class="flat-old-year">
                  <ul class="list-year">
                    <li>
                      <span class="dot heartbit"></span>
                    
                      <div class="event">
                        <h4  style="font-size:18px;">1.&#160; Menghormati privasi dan pilihan anda.</h4>
                      </div>
                    </li>
                    <li>
                      <span class="dot heartbit"></span>
                      <div class="event">
                        <h4  style="font-size:18px;">2. Menjamin adanya privasi dan keamanan dalam segala tindakan kami.</h4>
                      </div>
                    </li>
                    <li>
                      <span class="dot heartbit"></span>
                      <div class="event">
                        <h4  style="font-size:18px;">3. Tidak akan pernah menawarkan atau menjual data diri/perusahaan anda.</h4>
                      </div>
                    </li>
                    <li>
                      <span class="dot heartbit"></span>
                      <div class="event">
                        <h4  style="font-size:18px;">4. Berkomitmen untuk menjaga data anda dengan aman dan terlindungi. Hal ini termasuk dengan hanya bekerja sama dengan pihak-pihak yang terpercaya.</h4>
                      </div>
                    </li>
                  </ul>
                  <!-- /.list-year -->

                  <p style="font-size:18px; margin-top:50px; margin-left:0; line-height:40px; text-align:justify; color: #1e1e27;">
                    Ketika anda memberikan data pribadi/perusahaan 
                  anda kepada kami atau ketika kami mendapatkan data pribadi/perusahaan anda, 
                  kami akan menggunakan data tersebut sesuai dengan kepentingan kami dan anda sebagai vendor kami. 
                  Anda memahami dan menyetujui bahwa kami berhak menyimpan, mengolah, serta mentransfer data pribadi/perusahaan termasuk kemungkinan 
                  untuk mengungkapkan informasi pribadi/perusahaan anda kepada afiliasi kami atau pihak ketiga untuk tujuan dan kepentingan kami 
                  termasuk namun tidak terbatas pada tujuan dan kepentingan Invoice Portal ini. Jika anda memiliki pertanyaan atau kekhawatiran 
                  mengenai data pribadi/perusahaan anda, anda dapat menghubungi kami di CONSUMERADVISORY@loreal.com.</p>
