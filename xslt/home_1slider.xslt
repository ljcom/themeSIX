            ...
            <ul>
              ...
              <li data-index="rs-3050" data-transition="crossfade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                ...
                <div class="tp-caption sub-title color-black ff-2"
	                            ...
	                            style="z-index: 16; white-space: normal;font-weight: 300; color:blue;">
                  Invoice Portal
                </div>
                <script>
                ...
                <div class="tp-caption color-black ff-2"
	                            ...
	                            style="z-index: 16; white-space: nowrap;font-weight: 300; color:blue;">
                  ...
                  <div class="content-inner overflow">
                    ...
                    <div class="">
                      <ul class="padding-left-100">
                        ...
                        <li>
                          <i class="fa fa-check color-default" aria-hidden="true" style="margin-left:-30px"></i>Invoice
                        </li>
                        <li>
                          <i class="fa fa-check color-default" aria-hidden="true" style="margin-left:-30px"></i>Purchase Order (PO)
                        </li>
                        <li>
                          <i class="fa fa-check color-default" aria-hidden="true" style="margin-left:-30px"></i>Delivery Note (for goods), Statement of Work Completion or Certificat of Acceptance or Handover Certificate ( for services) that is signed by Loreal Stakeholder
                        </li>
                        <li>
                  ...
                  <div class="content-inner overflow">
                    <div class="">
                      <ul class="padding-left-100">
                        ...
                        <li>
                          <i class="fa fa-check color-default" aria-hidden="true" style="margin-left:-30px"></i>Invoice received at the maximum 30 days after definitive acceptance of delivery goods/completed services
                        </li>
